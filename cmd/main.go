...
import (
	...
	"github.com/ananyas28/kubernetes-security-operator/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "12dd6948.example.com",
	...
	if err := (&controller.SecurityMonitorReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "Failed to create controller", "controller", "securitymonitor")
		os.Exit(1)
	}
